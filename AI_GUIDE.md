...
**XP Multiplier** (`GameManager:getXPMultiplier()`) — **additive stacking**:
- Base: ×1
- DoubleXP: +1.0 → ×2
- VIP: +0.5 → ×1.5
- DoubleXP + VIP: ×2.5
...
**ExtraSlot**: 3rd item slot — `ItemManager:getMaxSlots()` returns 3 when owned, server guards + client UI adapts
