...
- [x] **Phase 2: Large Modal Scaling** - Apply scaling to the 5 large 780x580 modals, resolve UIStroke and ScrollingFrame pitfalls (completed 2026-03-21)
...
Plans:
- [x] 02-01-PLAN.md -- Extend ResponsiveScale with compensateStrokes helper + integrate TutorialUI and DailyBonusUI
- [x] 02-02-PLAN.md -- Integrate TitleCollectionUI and ClassSelectionUI with ScrollingFrame CanvasSize fixes
- [x] 02-03-PLAN.md -- Integrate ShopUI (3 ScrollingFrames + AbsoluteSize gacha fix) + visual verification of all 5 modals
...
Plans:
- [x] 03-01-PLAN.md -- Scale RaceResultsUI and SummaryUI with animation conversion and touch target fixes
- [x] 03-02-PLAN.md -- Scale MatchLobbyUI and StageSelectionUI with close button expansion and Position bug fix
- [x] 03-03-PLAN.md -- Safe area compliance (ScreenInsets explicit) + visual verification of all 4 modals
...
| 2. Large Modal Scaling | 3/3 | Complete   | 2026-03-21 |
| 3. Medium Modals + Touch + Polish | 0/3 | Not started | - |
